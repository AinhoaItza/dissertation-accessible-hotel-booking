    ...
    <header role="banner" class="bg-slate-900 text-white on-dark">
        <nav aria-label="Primary navigation" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                <a href="{{ route('home') }}" aria-label="StayNest — return to homepage"
                ...
                <ul role="list" class="flex items-center gap-1">
                    ...
                    @auth
                        ...
                        <li class="relative">
                            <button id="user-menu-btn" type="button" aria-haspopup="menu" aria-expanded="false"
                                ...
                                <svg id="user-menu-chevron" xmlns="http://www.w3.org/2000/svg"
                                    class="size-4 transition-transform duration-200" viewBox="0 0 24 24" fill="none"
                            ...
                            <ul id="user-menu" role="menu" aria-label="User account menu" hidden
                                class="off-dark absolute right-0 top-full mt-1 bg-white border border-slate-200 rounded-xl shadow-lg z-50 py-1 overflow-hidden" style="min-width: 100%;">
                                ...
                                <a href="{{ route('bookings.index') }}" role="menuitem"
                                    class="flex items-center gap-2 min-h-[44px] px-4 text-sm font-medium text-slate-900 hover:bg-slate-100 transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-4 shrink-0" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" aria-hidden="true" focusable="false">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <p class="text-slate-300 text-sm leading-relaxed">
                        Accessible hotel booking built to WCAG 2.2 AAA standards — because everyone deserves a great
                        stay.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-slate-300 text-sm mb-2 leading-relaxed">
                        ...
                        visible focus indicators, large touch targets (44×44 px), and full alt-text coverage for all
                        images.
                    </p>
                </div>
            </div>
